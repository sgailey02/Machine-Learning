...
class GUI: 
	...
	def __init__(self): 
		...
		# along with action 
		self.go = Button(self.login, text = "Continue", font = "BookAntiqua 12", command = lambda: self.goAhead(self.entryName.get())) 
	...
	def layout(self,name): 
		...
		self.Window.configure(width = 470, height = 550, bg = 'RoyalBlue1') 
		self.labelHead = Label(self.Window, bg = "gray38", fg = "snow", text = self.name , font = "BookAntiqua 12", pady = 5) 
		...
		self.textCons = Text(self.Window, width = 20, height = 2, bg = "RoyalBlue1", fg = "gray1", font = "BookAntiqua 12", padx = 5, pady = 5) 
